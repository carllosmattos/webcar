...
<h1 class="ls-title-intro ls-ico-plus">Adicionar Despesa para Gerador</h1>
<div class="ls-box">
  <hr>
      ...
      <div class="col-md-12">
        <div class="form-group col-md-4">
          <label class="ls-label col-md-12 @error('name_expense') ls-error @enderror">
            ...
            <input type="text" name="name_expense" value="{{old('name_expense')}}" required>
      ...
      <div class="col-md-12">
        <div class="form-group col-md-4">
          <label class="ls-label col-md-12 @error('unitary_value') ls-error @enderror">
            ...
            <input type="number" step="any" name="unitary_value" class="ls-no-spin form-control" value="{{old('unitary_value')}}" required>
        ...
        <div class="form-group col-md-4">
          <label class="ls-label col-md-12 @error('amount') ls-error @enderror">
            ...
            <input type="number" name="amount" class="ls-no-spin form-control" value="{{old('amount')}}" required>
      ...
      <div class="col-md-12">
        <div class="form-group col-md-4">
          <label class="ls-label col-md-12 @error('discount') ls-error @enderror">
            ...
            <input type="number" min="0" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" name="discount" value="{{old('discount')}}" required>
        ...
        <div class="form-group col-md-4">
          <label class="ls-label col-md-12 @error('data') ls-error @enderror">
            ...
            <input class="ls-no-spin" type="datetime-local" name="data" value="{{old('data')}}" required>
